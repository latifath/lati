...
<body>
    <div class="container-fluid col-md-8 offset-md-2">
                                ...
                                <table class="table table-condensed">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $item->quantite }}</td>
                                            <td>{{ produit($item->produit_id)->prix }}FCFA</td>
                                            <td>{{ number_format($item->quantite * $item->prix,'0', '.', ' ') }}</td>
                                        </tr>
                                        @endforeach
                                        <tr class="">
                                            <td colspan="3" class="text-right"><strong>Montant Total</strong></td>
                                            <td class="">{{ number_format(total_commande($cmde->id), '0', '.', ' ') }}FCFA</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="col-12 mt-5">
                        <div class="table-responsive">
                            <table class="table table-condensed">
                                ...
                                <tbody>
                                    <tr class="text-center">
                                        @if(exist_commande_paiement($cmde->id) != '')è
        ...
        <div class="row py-5 float-right pr-3">
            <button class="btn border" onClick="imprimer('facture')">
