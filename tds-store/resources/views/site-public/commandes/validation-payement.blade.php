                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <select class="custom-select {{ $errors->has('pays') ? 'is-invalid' : '' }}" name="pays">
                                @if (isset($adresseclient))
                                    <option value="{{ adresseclient($commande->adresse_client_id)->pays }}">{{ $adresseclient->pays }}</option>
                                @else
                ...
                <div class="modal-body" style="background-color: #f0f0f0;">
                    ...
                    <div class="">
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <select class="custom-select {{ $errors->has('pays') ? 'is-invalid' : '' }}" name="pays">
                                @if (isset($adresseclient))
                                    <option value="{{ adresselivraison($commande->adresse_livraison_id)->pays}}">{{ $adresseclient->pays }}</option>
                                @else
                                    <option selected>Bénin</option>
                                @endif
                                <option>Ghana</option>
