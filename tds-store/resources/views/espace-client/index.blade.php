        ...
        <div class="card mini-stat m-b-30">
            ...
            <div class="card-body">
                <div class="border-bottom pb-4">
                    ...
                    <span class="badge badge-success">{{ $nb_cmd_attente }}</span><span class="ml-2 text-muted">Commande en attente</span><br>
                ...
                <div class="mt-4 text-muted">
                    <h5 class="m-0">{{ $nb_cmd_effectuee + $nb_cmd_attente + $nb_cmd_annulee + $nb_cmd_non_payee }}<i class="mdi mdi-arrow-up text-success ml-2"></i></h5>
