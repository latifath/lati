                ...
                <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%; {{ couleur_principal() }}">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <button  id="btn_delete_user" data-id="{{ $user->id }}" class="btn text-white" style="{{ couleur_background_2() }}"><i class="fa fa-trash" aria-hidden="true"></i> Supprimer</button>
                            <button id='btn_edit_user' data-id="{{ $user->id }}" class="btn btn-primary"><i class="fa fa-edit" aria-hidden="true"></i> Editer</button>
